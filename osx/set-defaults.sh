...
sudo scutil --set ComputerName "sfedr-mac"
sudo scutil --set HostName "sfedr"
sudo scutil --set LocalHostName "sfedr"
...
# Show the ~/Library and ~/Projects folder
chflags nohidden ~/Library
chflags nohidden ~/Projects
